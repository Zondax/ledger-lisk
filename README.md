...
[![GithubActions](https://github.com/Zondax/ledger-lisk/actions/workflows/main.yml/badge.svg)](https://github.com/Zondax/ledger-lisk/blob/main/.github/workflows/main.yaml)
...
This project contains the Lisk app for Ledger Nano S Nano S+ and X.

- Ledger Nano S/S+/X Lisk app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-lisk/releases). You only need `installer.sh`
